...
public class WaitUtils {
	...
	public void waitForOverlay() {
		wait.until(d -> {
			try {
				List<WebElement> overlays = driver
						.findElements(By.cssSelector("div.overlay," + "div.spinner," + "div.ngx-spinner-overlay"
				// ".swal2-container," +
				// ".swal2-title"
				...
				/*
				 * .cdk-overlay-pane .mat-dialog-container .p-toast .swal2-popup remove the
				 * above if you get timeoutexception
				 */
		...
		wait.until(d -> driver.findElements(By.cssSelector(".ng-animating")).isEmpty());
	}
